...
<body class="bg-gray-100 overflow-hidden h-screen">
    ...
    <div class="flex flex-col lg:flex-row h-full p-4 lg:p-0 overflow-hidden">
        <!-- Sección de formulario -->
        <div class="lg:w-1/2 flex justify-center items-center p-8 bg-white rounded-2xl shadow-lg lg:m-3 h-full">
            <div class="bg-white rounded-lg p-8 w-full max-w-xl">
                ...
                <p class="text-gray-600 text-base mt-4 mb-5">¿No tienes cuenta?
        ...
        <!-- Sección de chat -->
        <div class="lg:w-1/2 hidden lg:flex flex-col justify-center items-center bg-gray-100 p-8 h-full">
